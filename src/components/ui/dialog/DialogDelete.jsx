...
const DialogDelete = ({ nameItem, isOpen, onClose, deleteAPI, messages }) => {
        ...
        <Dialog open={isOpen} onClose={handleClose} static={true}>
            <DialogPanel>
                {!confirmedDelete ? (
                    ...
                    <>
                        <h3 className="text-lg text-tremor-content-strong dark:text-dark-tremor-content-strong">{messages.delete}</h3>
